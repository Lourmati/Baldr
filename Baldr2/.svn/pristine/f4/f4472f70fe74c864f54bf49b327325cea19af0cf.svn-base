...
public class Prefwin extends javax.swing.JFrame implements Observer {
    ...
    private static class opts {
        ...
        static boolean extract_pdf;
        static boolean extract_image_pdf;
    }
    ...
    private void initComponents() {
        ...
        pdfExtractor1 = new javax.swing.JCheckBox();
        ...
        pdfExtractor.setText(messages.getString("extract_image_pdf"));
        ...
        pdfExtractor1.setText(messages.getString("extract_pdf"));
        pdfExtractor1.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        pdfExtractor1.setMaximumSize(new java.awt.Dimension(83, 15));
        pdfExtractor1.setMinimumSize(new java.awt.Dimension(83, 15));
        pdfExtractor1.setPreferredSize(new java.awt.Dimension(83, 15));

        jLabel7.setText("Extract pdf options");
                        ...
                        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            ...
                            .add(layout.createSequentialGroup()
                                ...
                                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                                    .add(pdfExtractor1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 373, Short.MAX_VALUE)
                                    .add(pdfExtractor, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                        .addContainerGap(org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .add(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
                ...
                .add(jLabel7)
                .add(18, 18, 18)
                .add(pdfExtractor1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .add(12, 12, 12)
    ...
    private void jButtonAppliquerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAppliquerActionPerformed
        saveMods();
        fenetre.ajustementSmartSommaire();
...
//        jPanel3.setVisible(false);
    ...
    private void loadPrefs() {
        ...
        if (preferences.prefExists("EXTRACT_PDF")) {
            pdfExtractor.setSelected(
                    (Boolean) preferences.readPref("EXTRACT_PDF", false));
        }
        opts.extract_pdf = pdfExtractor.isSelected();
        
        if (preferences.prefExists("extract_image_pdf")) {
            pdfExtractor1.setSelected(
                    (Boolean) preferences.readPref("extract_image_pdf", false));
        }
        opts.extract_image_pdf = pdfExtractor1.isSelected();
        ...
        opts.comparator = jTextFieldEditeur.getText();
        ...
        if (preferences.prefExists("extract_image_pdf")) {
            pdfExtractor1.setSelected((Boolean) preferences.readPref("extract_image_pdf", false));
        }
    }
...
//        }
        ...
        if (panneauResultat != null) {
            panneauResultat.setTableauVue(vueTableau);
        ...
        if (pdfExtractor1.isSelected()) {
            preferences.writePref("extract_image_pdf", true);
        } else {
            preferences.writePref("extract_image_pdf", false);
        }
    ...
    private javax.swing.JCheckBox pdfExtractor1;
