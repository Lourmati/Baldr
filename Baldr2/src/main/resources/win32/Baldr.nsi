...
;Descriptions
  ...
  LangString DESC_SecShort ${LANG_FRENCH} "Ajoute les raccourcis de Baldr dans le menu D�marrer de Windows"
  LangString DESC_SecExt ${LANG_FRENCH} "Associe l'extention .baldr � Baldr"
